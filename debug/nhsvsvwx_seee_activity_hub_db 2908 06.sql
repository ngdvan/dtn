...
--
-- Host: localhost:3306
-- Generation Time: Aug 29, 2026 at 06:30 AM
...
--
-- Database: `nhsvsvwx_seee_activity_hub_db`
--
CREATE DATABASE IF NOT EXISTS `nhsvsvwx_seee_activity_hub_db` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE `nhsvsvwx_seee_activity_hub_db`;
...
INSERT INTO `activities` (`id`, `title`, `description`, `is_public`, `public_image_url`, `proposal_document_url`, `type`, `status`, `priority`, `team_id`, `creator_id`, `requested_by`, `location`, `start_date`, `deadline`, `result_summary`, `created_at`, `updated_at`) VALUES
(2, 'HÀNH TRÌNH SEEE MÊ', 'Chuỗi sự kiện online kỉ niệm 5 năm thành lập SEEE dành cho sinh viên, cựu sinh viên.', 0, NULL, 'https://drive.google.com/drive/folders/17mmUW90k4wbKIFbx5-4rNARuLjbCIdGq', 'event', 'proposed', 'high', 5, 68, NULL, NULL, '2026-08-10', '2026-09-22', NULL, '2026-08-15 06:23:38', '2026-08-22 10:04:34'),
...
INSERT INTO `activity_teams` (`activity_id`, `team_id`, `role`, `responsibility`, `contact_user_id`) VALUES
...
INSERT INTO `notifications` (`id`, `user_id`, `activity_id`, `task_id`, `kind`, `title`, `body`, `url`, `source_key`, `seen_at`, `expires_at`, `created_at`) VALUES
(1, 87, 14, 33, 'task_deadline', 'Task due today', '“Hoàn thiện đề án giấy tờ” in “Tuyển Cộng tác viên kỳ 20261” is due today.', '/#activity/14', 'task-deadline:33:2026-08-24', '2026-08-26 03:03:20', '2026-08-31 12:18:19', '2026-08-24 12:18:19'),
...
INSERT INTO `participants` (`activity_id`, `user_id`, `state`, `responsibility`, `joined_at`) VALUES
(4, 66, 'confirmed', 'Activity participant', '2026-08-22 11:01:38'),
...
('002_roles_multi_team.sql', 'e88825d6b7d6a96244111707bbc2f22111f8fa16f5010a922a5dd9b6fb77c02a', '2026-08-21 03:12:56'),
...
('0G65NwrMO_AF1H8Dxze2wgRwXmzrhdqp', 1787963768, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-08-28T18:18:47.844Z\",\"secure\":true,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":64,\"name\":\"Đoàn Duy Anh\",\"email\":\"anh.dd233826@sis.hust.edu.vn\",\"role\":\"admin\",\"phone\":null,\"avatar_color\":\"#1622d0\"}}'),
...
('eaza7TY3mWoSjWZ8Y2ouUZwPB0wrqX0x', 1788002968, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-08-29T11:21:41.158Z\",\"secure\":true,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":2,\"name\":\"Nguyễn Đình Văn\",\"email\":\"van.nguyendinh@hust.edu.vn\",\"role\":\"admin\",\"phone\":null,\"avatar_color\":\"#5577a5\"}}'),
...
INSERT INTO `tasks` (`id`, `activity_id`, `title`, `description`, `stage`, `status`, `priority`, `team_id`, `assignee_id`, `assigned_by`, `start_date`, `deadline`, `deliverable`, `completed_at`, `created_at`) VALUES
(3, 2, 'Sửa đề án', NULL, 'before', 'done', 'medium', 5, 68, 68, NULL, '2026-08-18', NULL, '2026-08-18 14:39:58', '2026-08-16 16:33:40'),
...
INSERT INTO `task_attachments` (`id`, `task_id`, `user_id`, `kind`, `label`, `link_url`, `stored_name`, `original_name`, `mime_type`, `size_bytes`, `created_at`) VALUES
...
INSERT INTO `teams` (`id`, `name`, `description`, `color`, `is_active`, `sort_order`, `created_at`) VALUES
(1, 'Ban Thường Vụ', 'Ban Thường Vụ ĐTN - HSV SEEE 2026 - 2027', '#248eff', 1, 0, '2026-08-14 02:11:53'),
...
INSERT INTO `updates` (`id`, `activity_id`, `task_id`, `user_id`, `tagged_user_id`, `body`, `kind`, `attachment_url`, `created_at`) VALUES
(1, 2, NULL, 68, NULL, 'đã sửa lại các các nội dung về BGK và dự trù ạ ', 'progress', 'https://drive.google.com/drive/folders/1pdRcnPuo1_XBhTjeUITytTUnL-FDSU7i?usp=drive_link', '2026-08-21 06:02:50'),
...
INSERT INTO `update_tagged_users` (`update_id`, `user_id`) VALUES
(31, 66),
(32, 64);
...
INSERT INTO `users` (`id`, `name`, `email`, `password_hash`, `role`, `phone`, `avatar_color`, `is_active`, `created_at`) VALUES
...
ALTER TABLE `activities`
  ...
  ADD KEY `activities_public` (`is_public`,`created_at`);
ALTER TABLE `activities` ADD FULLTEXT KEY `activity_search` (`title`,`description`,`result_summary`);

--
-- Indexes for table `activity_teams`
--
...
ALTER TABLE `documents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `documents_year` (`applicable_year`),
  ADD KEY `documents_team` (`issuing_team_id`),
  ADD KEY `fk_documents_creator` (`created_by`);
...
ALTER TABLE `notifications`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `notifications_user_source` (`user_id`,`source_key`),
  ADD KEY `notifications_inbox` (`user_id`,`seen_at`,`created_at`),
  ADD KEY `notifications_expiry` (`expires_at`),
  ADD KEY `notifications_activity` (`activity_id`),
  ADD KEY `notifications_task` (`task_id`);
...
ALTER TABLE `tasks`
  ...
  ADD KEY `tasks_assigned_by` (`assigned_by`);
...
ALTER TABLE `updates`
  ...
  ADD KEY `task_id` (`task_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `updates_tagged_user` (`tagged_user_id`);

--
-- Indexes for table `update_tagged_users`
--
ALTER TABLE `update_tagged_users`
  ADD PRIMARY KEY (`update_id`,`user_id`),
  ADD KEY `update_tagged_users_user` (`user_id`);
...
--
ALTER TABLE `notifications`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2284;
...
--
ALTER TABLE `activities`
  ADD CONSTRAINT `activities_ibfk_1` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`),
  ADD CONSTRAINT `activities_ibfk_2` FOREIGN KEY (`creator_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `activity_teams`
--
ALTER TABLE `activity_teams`
  ADD CONSTRAINT `activity_teams_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `activity_teams_ibfk_2` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`),
  ADD CONSTRAINT `activity_teams_ibfk_3` FOREIGN KEY (`contact_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `documents`
--
ALTER TABLE `documents`
  ADD CONSTRAINT `fk_documents_creator` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fk_documents_team` FOREIGN KEY (`issuing_team_id`) REFERENCES `teams` (`id`);
...
--
ALTER TABLE `participants`
  ADD CONSTRAINT `participants_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `tasks`
  ...
  ADD CONSTRAINT `tasks_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `task_attachments`
  ...
  ADD CONSTRAINT `task_attachments_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE `updates`
  ...
  ADD CONSTRAINT `updates_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `updates_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `updates_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `update_tagged_users`
--
ALTER TABLE `update_tagged_users`
  ADD CONSTRAINT `fk_update_tagged_users_update` FOREIGN KEY (`update_id`) REFERENCES `updates` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_update_tagged_users_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `user_teams`
  ...
  ADD CONSTRAINT `user_teams_ibfk_2` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE;
COMMIT;
